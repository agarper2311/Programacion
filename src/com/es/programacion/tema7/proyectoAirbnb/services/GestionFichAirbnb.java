...
public class GestionFichAirbnb {
    ...
    /**
     * M�todo para cargar los alojamientos del csv de M�laga
     */
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(archivo))) {
            ...
            while ((linea = br.readLine()) != null) {
                ...
                if (partes.length >= 5) {
                    ...
                    /*
                     *  Ten�a un fallo con esta l�nea, he prescindido de chatGPT para resolverlo
    ...
    /**
     * M�todo para guardar los alojamientos en el archivo datos_malaga.csv
     */
