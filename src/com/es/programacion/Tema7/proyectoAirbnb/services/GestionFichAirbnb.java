...
public class GestionFichAirbnb {
    ...
    /**
     * Método para cargar los alojamientos del csv de Málaga
     */
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(archivo))) {
            ...
            while ((linea = br.readLine()) != null) {
                ...
                if (partes.length >= 5) {
                    ...
                    /*
                     *  Tenía un fallo con esta línea, he prescindido de chatGPT para resolverlo
    ...
    /**
     * Método para guardar los alojamientos en el archivo datos_malaga.csv
     */
    ...
    public static List<Alojamiento> caros(List<Alojamiento> alojamientos, int n) {
        alojamientos.sort(Collections.reverseOrder());
        List<Alojamiento> resultado = new ArrayList<>();
        for (int i = 0; i < Math.min(n, alojamientos.size()); i++) {
            resultado.add(alojamientos.get(i));
        }
